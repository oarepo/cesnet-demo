...
"""Default configuration for CESNET OA Repository Demo.
...
BASE_TEMPLATE = 'cesnet_demo/page.html'
...
# ===================
#: Site name
THEME_SITENAME = _('CESNET OA Repository Demo')
#: Use default frontpage.
THEME_FRONTPAGE = True
#: Frontpage title.
THEME_FRONTPAGE_TITLE = _('CESNET OA Repository Demo')
#: Frontpage template.
THEME_FRONTPAGE_TEMPLATE = 'cesnet_demo/frontpage.html'
...
SECURITY_EMAIL_SUBJECT_REGISTER = _(
    "Welcome to CESNET OA Repository Demo!")
...
SQLALCHEMY_DATABASE_URI = \
    'postgresql+psycopg2://cesnet-demo:cesnet-demo@localhost/cesnet-demo'
